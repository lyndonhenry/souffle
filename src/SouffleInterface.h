...
public:
     ...
     */
    virtual void runAll(std::string inputDirectory = ".", std::string outputDirectory = ".", size_t stratumIndex = -1) = 0;
     ...
     * @param retErr Error state of the subroutine (std::vector<bool>&)
     */
